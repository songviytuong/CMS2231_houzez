...
//alert(data.query);
                    ...
                    advanced_search_price_range_min = parseInt(data.min_price);
                    advanced_search_price_range_max = parseInt(data.max_price);
        ...
        var houzez_search_on_change = function (current_form, form_widget, current_page,  min_price_onchange_status, max_price_onchange_status, only_city, only_state, only_country ) {
            ...
            if(current_tempalte == 'property-listings-map') {
