...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="{$mod->GetModuleURLPath()}/css/filepicker.min.css" />
	</head>
	{strip}
	...
	{/strip}
	{cms_jquery exclude='ui,cms_js_setup,ui_touch_punch,nestedSortable,json,migrate,cms_admin,cms_autorefresh,cms_dirtyform,cms_hiersel,cms_lock' append="`$mod->GetModuleURLPath()`/js/filebrowser.js"}
