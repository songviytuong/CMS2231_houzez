...
/**
 * Converts an image to transparent, by specifying a color that should become the transparent color.
 * 
 * @author Robert Campbell <calguy1000@cmsmadesimple.org>
 * @package CGSmartImage
 */
class CGImage_Transparent_Filter extends CGImageFilterBase
{
  /**
  ...
  public function __construct(/* variable arguments */)
  {
    ...
    if( count($args) >= 2 ) $this->_alpha = (int)$args[1];
