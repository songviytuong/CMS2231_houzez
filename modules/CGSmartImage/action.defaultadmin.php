...
echo $this->SetTabHeader('autoprocessing',$this->Lang('autoprocessing'));
...
echo $this->StartTab('autoprocessing',$params);
include(__DIR__.'/function.admin_autoprocessing_tab.php');
echo $this->EndTab();
