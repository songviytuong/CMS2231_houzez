...
<div class="pageoverflow">
  <p class="pagetext"><label for="allowmle">{$allowmle}:</label>&nbsp;{cms_help key2='help_general_allowmle' title=$mod->Lang('prompt_allowmle')}</p>
  <p class="pageinput">{$allowmleinput}</p>
</div>
<div class="pageoverflow">
