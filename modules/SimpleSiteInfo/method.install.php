...
$default_password = substr(str_shuffle('abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789') , 0 , 24);
$this->SetPreference('SimpleSiteInfoPwd', $default_password);	
