...
$categories = cd_category::get_tree();
$smarty->clear_assign('categories');
if( is_array($categories) && count($categories) ) $smarty->assign('categories', $categories);
$smarty->assign('url_add_category',$this->create_url($id,'editcategory',$returnid));
