...
$smarty->assign('formstart',$this->CGCreateFormStart($id,'admin_save_email_template'));
$smarty->assign('formend',$this->CreateFormEnd());
$smarty->assign('email_subject',$this->GetPreference('admin_feedit_email_subject'));
$smarty->assign('email_template',$this->GetTemplate('admin_feedit_email_template'));
$smarty->assign('email_ishtml',$this->GetPreference('admin_feedit_email_ishtml'));
