...
$this->SetCurrentTab('frontendimport_template');
if( isset($params['feimport_submit']) )
  {
    $this->SetTemplate(COMPANYDIR_FRONTENDIMPORT_TEMPLATE,
		       trim($params['feimport_template']));
  }
 else if( isset($params['feimport_reset']) ) {
