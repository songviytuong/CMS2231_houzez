...
$action = $name;
// this tab can be activated by ajax.


#Put together a list of current categories...
$entryarray = array();

$hier = cd_utils::get_hierarchy(TRUE);
if( is_array($hier) && count($hier) ) $smarty->assign('hier',$hier);
$smarty->assign('hier',$hier);

#Setup links
$smarty->assign('add_url',$this->create_url($id,'admin_addhier',$returnid));
$smarty->assign('update_url',$this->create_url($id,'admin_updatehier',$returnid));
if( $action == 'admin_hiertab' ) $smarty->assign('ajax',1);

#Display template
echo $this->ProcessTemplate('hierlist.tpl');
