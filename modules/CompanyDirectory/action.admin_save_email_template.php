...
$this->SetCurrentTab('email_template');
if( isset($params['reset']) ) {
  ...
  $this->SetPreference('admin_feedit_email_ishtml',(int)$params['email_ishtml']);
  $this->SetPreference('admin_feedit_email_subject',trim($params['email_subject']));
  $this->SetTemplate('admin_feedit_email_template',trim($params['email_template']));
}
