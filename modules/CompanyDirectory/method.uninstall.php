...
$sqlarray = $dict->DropTableSQL( cms_db_prefix()."module_compdir_hier" );
$dict->ExecuteSQLArray($sqlarray);

$sqlarray = $dict->DropTableSQL( cms_db_prefix()."module_compdir_searchstats" );
$dict->ExecuteSQLArray($sqlarray);

$sqlarray = $dict->DropTableSQL( cms_db_prefix()."module_compdir_searchstats_vars" );
$dict->ExecuteSQLArray($sqlarray);

$sqlarray = $dict->DropTableSQL( cms_db_prefix()."module_compdir_searchstats_res" );
$dict->ExecuteSQLArray($sqlarray);
...
$this->RemoveEvent('OnAddCompany');
$this->RemoveEvent('OnEditCompany');
$this->RemoveEvent('OnDeleteCompany');
