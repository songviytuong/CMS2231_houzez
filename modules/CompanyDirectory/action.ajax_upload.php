...
// get the name of the album... and convert it to an alias
$options = array('param_name'=>'image_upload');
$options['compid'] = $compid;
$options['fdid'] = $fdid;
$options['upload_dir'] = cms_join_path($config['uploads_path'],'companydirectory','id'.$compid,'album_'.$fdid).'/';
$options['upload_url'] = $config['uploads_url']."/companydirectory/id{$compid}/album_$fdid";
