...
$lang['enable_contextmenu'] = 'Enable context menu (right-click menu)';
...
$lang['filemanager_aviary_active'] = 'Enable the Aviary photo editor';
$lang['filemanager_aviary_apiKey'] = 'Aviary API key';
...
$lang['filemanager_photo_editor'] = 'Aviary photo editor';
...
$lang['help_aviary'] = 'Aviary editor is an external image editing tool provided by Adobe.';
...
$lang['help_enable_custom_dropdown'] = 'Adds a special button so the editors can add some snippets (Smarty tags or not) to their content. Don\'t forget to add the <em><strong>customdropdown</strong></em> button to your toolbar. The <em>Insert</em> menu shows it too.';
...
$lang['help_user_templates'] = 'User templates are HTML templates/blocks that TinyMCE users can easily include in the content using the <em>template</em> plugin. You can create as many user templates as you want in the CMSMS Design Manager (template type: <em>TinyMCE user template</em>).<br><br>Once enabled, don\'t forget to add the <em>template</em> button to you toolbar, if needed. It will be automatically added to the menubar.';
...
$lang['subhelp_contextmenu_content'] = 'Syntax: <em>cmsms_linker link image | inserttable cell</em>';
...
$lang['subhelp_custom_dropdown'] = 'Syntax: <em>Item title|content to add</em> or <em>Item title|opening content|end content</em> to add <em>opening content</em> before selection, and <em>end content</em> after it.<br>Don\'t forget to add <em><strong>customdropdown</strong></em> to your toolbar buttons';
$lang['submit'] = 'Submit';
...
<h3>Module developers: how to create a new button for my module in TinyMCE?</h3>
<p>
...
<ul>
	...
	<li>Mathieu Muths: <a href="mailto:contact@airelibre.fr">contact@airelibre.fr</a></li>
</ul>
EOT;
