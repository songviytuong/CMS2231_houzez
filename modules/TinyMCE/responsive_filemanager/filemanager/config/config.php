...
// Require wont work in java upload dialog because it is called from a subdirectory
...
return array_merge(
	$filemanager_config,
	array(
		'MaxSizeUpload' => ((int)(ini_get('post_max_size')) < $filemanager_config['MaxSizeUpload'])
			? (int)(ini_get('post_max_size')) : $filemanager_config['MaxSizeUpload'],
		'ext'=> array_merge(
		...
		'aviary_defaults_config' => array(
			'apiKey'     => $filemanager_config['aviary_apiKey'],
			'language'   => $filemanager_config['aviary_language'],
			'theme'      => $filemanager_config['aviary_theme'],
			'tools'      => $filemanager_config['aviary_tools'],
			'maxSize'    => $filemanager_config['aviary_maxSize']
		),
	)
);
?>
