...
class RequiredFieldValidationEditor extends ValidationEditor
{
    private $_validator;
    private $_mod;
    ...
    {
        $this->_mod = $mod;
        $this->_validator = new RequiredFieldValidation;
    }

    public function get_name()
    {
        return $this->_mod->Lang('name_RequiredFieldValidator');
    }
    ...
    {
        if( ! $in instanceof RequiredFieldValidation ) throw new \LogicException('Invalid validation passed to '.__METHOD__);
        $this->_validator = $in;
    }
