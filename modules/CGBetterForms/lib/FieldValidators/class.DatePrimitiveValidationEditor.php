...
class DatePrimitiveValidationEditor extends ValidationEditor
{
    private $_validator;
    private $_mod;
    ...
    {
        $this->_mod = $mod;
        $this->_validator = new DatePrimitiveValidation;
    }

    public function get_name()
    {
        return $this->_mod->Lang('name_DatePrimitiveValidator');
    }
    ...
    {
        if( ! $in instanceof DatePrimitiveValidation ) throw new \LogicException('Invalid validation passed to '.__METHOD__);
        $this->_validator = $in;
    }
