...
<html>
    <head>
        ...
        <meta name="generator" content="Copyright (C) 2004-16 Lee Peace. All rights reserved." />
        ...
        <div id="wrapper">
            <div class="login-container">
                <div class="login-box cf"{if isset($error)} id="error"{/if}>
                    <div class="logo">
                        <img src="{$config.admin_url}/themes/OneEleven/images/layout/cmsms_login_logo.png" alt="Lee Peace&trade;" />
                    </div>
