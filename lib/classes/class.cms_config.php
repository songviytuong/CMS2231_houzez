...
final class cms_config implements ArrayAccess
{
  ...
  /**
   * Returns either the http image themes url or the https image uploads url depending upon the request mode.
   */
  public function smart_themes_url()
  {
	  return $this->offsetGet('themes_url');
	  //+Lee
  }
} // end of class
