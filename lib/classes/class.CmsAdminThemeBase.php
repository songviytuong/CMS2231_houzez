...
abstract class CmsAdminThemeBase
{
	...
	private function _SetAggregatePermissions($force = FALSE)
	{
        ...
        $this->_perms['adminlog'] = check_permission($this->userid, 'Clear Admin Log');
        $this->_perms['systemmaintenance'] = check_permission($this->userid, 'System Maintenance');
        $this->_perms['systeminfo'] = check_permission($this->userid, 'System Information');
        $this->_perms['systemverification'] = check_permission($this->userid, 'System Verification');
    ...
    private function _populate_admin_navigation($subtitle='')
    {
		...
		$items['systeminfo'] = array('url' => 'systeminfo.php', 'parent' => 'siteadmin','priority'=>2,
									 ...
									 'show_in_menu' => $this->HasPerm('systeminfo'));
		$items['systemmaintenance'] = array('url' => 'systemmaintenance.php','priority'=>1,'parent' => 'siteadmin',
											...
											'show_in_menu' => $this->HasPerm('systemmaintenance'));
		$items['checksum'] = array('url' => 'checksum.php', 'parent' => 'siteadmin','priority'=>4,
								   ...
								   'show_in_menu' => $this->HasPerm('systemverification'));
		$items['adminlog'] = array('url'=>'adminlog.php','parent'=>'siteadmin','priority'=>10,
								   ...
								   'show_in_menu'=>$this->HasPerm('adminlog'));
		// base my prefs menu ---------------------------------------------------------
